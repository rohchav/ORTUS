...
export default function AtlasPage() {
  return (
    <FutureDestinationSurface
      destinationId="atlas"
      implementationCopy="Atlas is a future Research World destination. Discovery records, behavioral landscapes, sampled-region maps, and evidence-linked model regimes are not implemented in GW1."
