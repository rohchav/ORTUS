...
describe("R2 World layout and interaction reclaim contracts", () => {
  ...
  it("records completed PERF1 after I0B with PERF1B next", () => {
    ...
    expect(context).toContain("PERF1B: Runtime Performance Architecture Audit is next");
    expect(context).toContain("I1: Immersive World Shell has not started");
    expect(context).toContain("C4: Flagship Starter Pack Two is deferred until I5B");
