export const workspacePlacements = ["leftRail", "leftDrawer", "rightDrawer", "bottomDock", "floatingOverlay", "workspace"] as const;
...
export const workspacePanelDefinitions: readonly WorkspacePanelDefinition[] = [
  {
    ...
    label: "Micro Field",
    eyebrow: "Local Rules",
    description: "Template parameters and local agent rules.",
    defaultPlacement: "leftRail",
    supportedPlacements: ["leftRail"],
    defaultSize: "compact",
  ...
  },
  {
    ...
    defaultPlacement: "leftRail",
    supportedPlacements: ["leftRail", "bottomDock"],
    defaultSize: "compact",
  ...
  },
  {
    ...
    defaultPlacement: "leftRail",
    supportedPlacements: ["leftRail", "leftDrawer", "workspace"],
    defaultSize: "compact",
  ...
  },
  {
    ...
    defaultPlacement: "leftRail",
    supportedPlacements: ["leftRail", "leftDrawer"],
    defaultSize: "compact",
  ...
  },
  {
    ...
    defaultPlacement: "leftRail",
    supportedPlacements: ["leftRail", "bottomDock", "workspace"],
    defaultSize: "compact",
  ...
  },
  {
    ...
    defaultPlacement: "floatingOverlay",
    supportedPlacements: ["floatingOverlay"],
    defaultSize: "compact",
    supportedSizes: ["collapsed", "compact"],
    glyph: "LK",
    order: 110,
  ...
  },
  {
    ...
    defaultPlacement: "floatingOverlay",
    supportedPlacements: ["floatingOverlay", "rightDrawer"],
    defaultSize: "compact",
    supportedSizes: ["collapsed", "compact", "drawer"],
    glyph: "DB",
    order: 120,
