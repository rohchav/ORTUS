...
describe("R1 Start Hub and World-first product reset contracts", () => {
  ...
  it("records completed C2B with C3 next and preserves every implementation-audit pair", () => {
    ...
    expect(roadmap).toContain("Status: active product sequence; R1, R1B, R2, R2B, C1, C1B, C2, and C2B complete; C3 next");
