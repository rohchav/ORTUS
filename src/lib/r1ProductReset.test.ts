...
describe("R1 Start Hub and World-first product reset contracts", () => {
  ...
  it("records completed I0B with I1 next and preserves every implementation-audit pair", () => {
    ...
    expect(roadmap).toContain("Status: active product sequence; R1 through C3B and I0/I0B complete; I1 next; C4 deferred until I5B");
    ...
    expect(roadmap).toContain("`I0: Immersive World Direction + Performance Baseline` and `I0B: Immersive World Direction Audit + Performance Hardening` are complete.");
    expect(roadmap).toContain("`I1: Immersive World Shell` is next and has not started.");
