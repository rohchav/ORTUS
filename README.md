...
- An isolated, unlinked I0 comparison route at `/world/immersive-prototype` with three real-engine Flocking presentation prototypes: Living Diorama, God-Hand, and Field Scientist. It is non-persistent prototype evidence, not the production World replacement.
