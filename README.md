...
ORTUS has completed Prompt 36B: Visual Builder Graph View Audit. The post-30B repository hygiene, durable context, dependency stabilization, and performance/scalability pass is also complete. Prompt 31 through Prompt 36B are complete; the next roadmap prompt is Prompt 37: Schema Validation UX + Repair Suggestions V1.
