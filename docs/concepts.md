...
GW3 intervention readiness is a live World UI summary of existing template-owned controls and current target readiness. It is not a saved intervention plan, experiment record, Lab artifact, Atlas discovery, policy recommendation, validation result, or proof that an intervention would work in the real system.
