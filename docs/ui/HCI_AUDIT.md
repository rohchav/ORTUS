...
- Prompt GW6 Contextual Capability Guidance. World, Workshop, Lab, and Atlas now show static source-backed guidance for current capability boundaries; saved records, Atlas discoveries, Lab experiments, behavioral landscapes, generated advice, progression, persistence, runtime behavior, template behavior, Builder execution behavior, validation, calibration, dependencies, assets, and fonts do not.
