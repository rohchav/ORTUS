...
Lab is a reachable non-persistent GW5 foundation, not a saved evidence-record system. Atlas is a reachable non-persistent GW4/GW7 foundation, audited through GW7B. Atlas now includes behavioral-landscape vocabulary and a conceptual scaffold, but Lab and Atlas do not contain persistent experiments, notebooks, saved Discovery Atlas records, saved behavioral landscape maps, sampled data, run sweeps, regime detection, progression, fake counts, fake maps, fake records, or fake user activity.
