...
```text
1. Review and commit Prompt GW7 Behavioral Landscape Exploration Foundation work if this worktree is still uncommitted.
2. Do not start GW7B or further Research World work unless the user explicitly directs it; also do not start F1, Scale Lens, fractal metrics, fractal generators, network scaling analytics, trajectory motif analytics, or any further Research World/fractal/multiscale implementation.
...
Next Research World prompt: Prompt GW7B only with explicit approval.
```
