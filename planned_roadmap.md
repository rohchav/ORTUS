...
```text
1. Review and commit Prompt GW6B Contextual Capability Guidance Audit work if this worktree is still uncommitted.
2. Do not start GW7 or further Research World work unless the user explicitly directs it; also do not start F1, Scale Lens, fractal metrics, fractal generators, network scaling analytics, trajectory motif analytics, or any further Research World/fractal/multiscale implementation.
...
Next Research World prompt: Prompt GW7 only with explicit approval.
```
