...
Recommended sandbox-theme sequence: UX4 -> UX4B -> UX5 -> UX5B -> UX6 -> UX6B -> GW9.
```
...
```text
1. Review and commit Prompt UX3 Full UI/UX Comprehension and Sandbox-Theme Audit work if this worktree is still uncommitted.
2. Run Prompt UX4: Sandbox Visual Language Foundation next.
