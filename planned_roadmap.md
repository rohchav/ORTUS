...
*Last updated after Prompt GW5B Lab evidence record information architecture audit and rendered verification.*
...
2. Do not start GW6 Research World work unless the user explicitly directs it; also do not start F1, Scale Lens, fractal metrics, fractal generators, network scaling analytics, trajectory motif analytics, or any further Research World/fractal/multiscale implementation.
...
Next Research World prompt: Prompt GW6 Contextual Capability Guidance only with explicit approval.
```
