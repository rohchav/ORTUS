...
Completed implementation prompt: Prompt GW6 — Contextual Capability Guidance; adds static source-backed capability guidance on World, Workshop, Lab, and Atlas without saved records, Atlas discoveries, Lab experiments, behavioral landscapes, progression, generated advice, persistence, runtime behavior, template behavior, Builder execution, validation, or calibration
...
```text
1. Review and commit Prompt GW6 Contextual Capability Guidance work if this worktree is still uncommitted.
2. Do not start GW6B or further Research World work unless the user explicitly directs it; also do not start F1, Scale Lens, fractal metrics, fractal generators, network scaling analytics, trajectory motif analytics, or any further Research World/fractal/multiscale implementation.
...
Next Research World prompt: Prompt GW6B Contextual Capability Guidance Audit only with explicit approval.
```
