...
- R1 through C3B and I0/I0B are complete. I1: Immersive World Shell is next and unstarted; I2 through I5B are reserved; C4 is deferred until I5B. Do not start I1, C4, or later I/C/S/E milestones without a dedicated prompt.
...
- GW9/GW9B do not generalize Atlas sampling, make the conceptual behavioral-landscape scaffold runtime-backed, make probe plans executable, or create Discovery Atlas/Lab persistence. GW9B, R1, R1B, R2, R2B, C1, C1B, C2, C2B, C3, C3B, I0, and I0B are complete. I1 is next and unstarted; C4 is deferred until I5B; F1 is paused under E3 Analytical Lenses.
...
- At the audited 500-boid bound, Flocking engine neighbor search and cloning/snapshot allocation dominated measured main-thread pressure; Canvas draw was not the primary cost. Do not claim WebGL, Canvas micro-optimization, worker execution, or high-scale readiness without a dedicated implementation and matched profiling evidence.
